...
namespace SQLCLRex.Deliveries
{
    ...
    /// Comparer для словаря
    /// </summary>
    public class DeliveryKeyComparerEx : IEqualityComparer<int[]>
    {
        /// <summary>
        /// Количество заказов
        /// </summary>
        ...
        /// </summary>
        /// <param name="orderCount"></param>
        public DeliveryKeyComparerEx(int orderCount)
        {
            _orderCount = orderCount;
        }
        ...
        public int GetHashCode(int[] obj)
        {
            ...
            if (_orderCount <= 16)
            {
                switch (obj.Length)
                {
                    ...
                    case 3:
                        return obj[0] << 8 | obj[1] << 4 | obj[2];
                    case 4:
                        return obj[0] << 12 | obj[1] << 8 | obj[2] << 4 | obj[3];
                    case 5:
                        return obj[0] << 16 | obj[1] << 12 | obj[2] << 8 | obj[3] << 4 | obj[4];
                    case 6:
                        return obj[0] << 20 | obj[1] << 16 | obj[2] << 12 | obj[3] << 8 | obj[4] << 4 | obj[5];
                    case 7:
                        return obj[0] << 24 | obj[1] << 20 | obj[2] << 16 | obj[3] << 12 | obj[4] << 8 | obj[5] << 4 | obj[6];
                    default:
                        return obj[0] << 28 | obj[1] << 24 | obj[2] << 20 | obj[3] << 16 | obj[4] << 12 | obj[5] << 8 | obj[6] << 4 | obj[7];
                }
            }
            else if (_orderCount <= 256)
            {
                switch (obj.Length)
                {
                    case 1:
