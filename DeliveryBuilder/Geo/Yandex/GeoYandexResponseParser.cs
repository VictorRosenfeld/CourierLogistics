...
namespace DeliveryBuilder.Geo.Yandex
{
    ...
    /// </summary>
    public class GeoYandexResponseParser
    {
        ...
        public static int TryParse(string json, out GeoYandexResponseItem[] items)
        {
            // 1. Инициализация
            int rc = 1;
            items = null;
            ...
            try
            {
                ...
                items = new GeoYandexResponseItem[json.Length / sz];
                ...
                while (i < json.Length - sz)
                {
                    ...
                    if (eoi)
                    {
                        if (distance >= 0 && duration >= 0 && status != null)
                        {
                            ...
                            items[count++] = new GeoYandexResponseItem(distance, duration, status);
