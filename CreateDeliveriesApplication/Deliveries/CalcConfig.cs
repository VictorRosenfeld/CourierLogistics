...
namespace CreateDeliveriesApplication.Deliveries
{
    ...
    public class CalcConfig
    {
        ...
        /// <summary>
        /// Величина расширения временного окна доставки влво и вправо
        /// при фильтрации заказов по времени, мин
        /// </summary>
        public int CloudDelta { get; set; }
