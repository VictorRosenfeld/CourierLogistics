...
{
    using CreateDeliveriesApplication.AverageDeliveryCost;
    using CreateDeliveriesApplication.Couriers;
    using CreateDeliveriesApplication.DeliveryCover;
    using CreateDeliveriesApplication.ExtraOrders;
    ...
    public class CreateDeliveries
    {
        ...
        public static int Create(CalcConfig config)
        {
            // 1. Инициализация
            ...
            try
            {
                ...
                while (iterationOrderCount > 0)
                {
                    ...
                    else if (iterationOrderCount > startOrderCount)
                    {
                        ...
                        rc1 = OrdersCloud.FindCloud(iterationOrders, startOrderCount, calcContext.Config.CloudRadius, calcContext.Config.CloudDelta, geoDist, out threadContextOrders);
#if debug
