    ...
    public class GetOrderEvents
    {
        ...
        public static int GetEvents(int requestType, out OrderEvent[] events)
        {
            ...
            try
            {
                ...
                Logger.WriteToLog(string.Format(MessagePatterns.ORDER_EVENTS_REQUEST, request.Address.OriginalString));
                ...
                using (HttpWebResponse response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    {
                        Logger.WriteToLog(string.Format(MessagePatterns.ORDER_EVENTS_ERROR_RESPONSE, response.StatusCode, response.StatusDescription));
                    ...
                    using (StreamReader reader = new StreamReader(response.GetResponseStream()))
                    {
                        ...
                        Logger.WriteToLog(string.Format(MessagePatterns.ORDER_EVENTS_RESPONSE, json));
