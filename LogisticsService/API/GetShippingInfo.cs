    ...
    public class GetShippingInfo
    {
        ...
        public static int GetInfo(ShippingInfoRequest requestData, out ShippingInfoResponse responseData)
        {
            ...
            try
            {
                ...
                Logger.WriteToLog(string.Format(MessagePatterns.TIME_DIST_REQUEST, request.Address.OriginalString));
                ...
                Logger.WriteToLog(string.Format(MessagePatterns.TIME_DIST_POST_DATA, postData));
                ...
                using (HttpWebResponse response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    {
                        Logger.WriteToLog(string.Format(MessagePatterns.TIME_DIST_ERROR_RESPONSE, response.StatusCode, response.StatusDescription));
                    ...
                    using (StreamReader reader = new StreamReader(response.GetResponseStream()))
                    {
                        ...
                        Logger.WriteToLog(string.Format(MessagePatterns.TIME_DIST_RESPONSE, json));
