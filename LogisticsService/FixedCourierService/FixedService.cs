...
//        /// </summary>
//        private SalesmanSolution salesmanSolution;
...
//                // 4. Создаём Location Manager
//                rc = 4;
//                int capacity = config.functional_parameters.max_points_number;
//                if (capacity < 300) capacity = 300;
//                locationManager = new LocationManager(capacity);
...
//                rc1 = allOrders.Create(locationManager);
//                if (rc1 != 0)
//                    return rc = 100 * rc + rc1;

//                // 7. Создаём All shops
//                rc = 7;
//                allShops = new AllShops();
//                rc1 = allShops.Create(locationManager);
//                if (rc1 != 0)
//                    return rc = 100 * rc + rc1;

//                salesmanSolution = new SalesmanSolution(locationManager);
...
//                try { requestTimer.Stop(); } catch { }
//                try { queueTimer.Stop(); } catch { }
//            }
//            catch
//            {  }
//        }
...
//            try
//            {
//                isCatched = syncMutex.WaitOne(60000);
//                Refresh(0);
//            }
//            catch
//            {   }
...
//            try
//            {
//                return salesmanSolution.CreateShopDeliveries(shop, shopOrders, shopCouriers, true, out assembledOrders, out receiptedOrders, out undeliveredOrders);
//            }
//            catch
//            {
//                return rc;
...
//                    if (eventTime < delivery.StartDeliveryInterval) eventTime = delivery.StartDeliveryInterval;
//                    DateTime currentTime = DateTime.Now;
