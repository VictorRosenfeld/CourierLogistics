...
namespace CourierLogistics.SourceData.Couriers
{
    ...
    /// </summary>
    public class CourierType_Bicycle : ICourierType
    {
        /// <summary>
        /// Тип курьера
        /// </summary>
        public CourierVehicleType VechicleType => CourierVehicleType.Bicycle;
        ...
        public int GetTimeAndCost(double distance, double weight, out double deliveryTime, out double executionTime, out double cost)
        {
            ...
            try
            {
                ...
                rc = 3;
                double distTime = 60 * distance / AverageVelocity;   // minutes
                deliveryTime = GetOrderTime + distTime + HandInTime; // minutes
        ...
        public int GetTimeAndCost(double[] nodeDistance, double totalWeight, out double[] nodeDeliveryTime, out double totalDeliveryTime, out double totalExecutionTime, out double totalCost)
        {
            ...
            try
            {
                ...
                //nodeDeliveryTime[nodeDistance.Length - 1] -= HandInTime;
                ...
                // ))))
                //totalExecutionTime = nodeDeliveryTime[nodeDeliveryTime.Length - 1] + HandInTime;
