...
namespace CourierLogistics.SourceData.Couriers
{
    ...
    /// Gett-такси
    /// </summary>
    public class CourierType_GettTaxi : ICourierType
    {
        /// <summary>
        /// Тип курьера
        /// </summary>
        public CourierVehicleType VechicleType => CourierVehicleType.GettTaxi;
        ...
        /// </summary>
        public double FirstDistance => 3;

        /// <summary>
        /// Стоимость дополнительного километра (свыше FirstDistance), руб/км
        /// </summary>
        public double AdditionalKilometerCost => 11;
