...
namespace CourierLogistics.SourceData.Couriers
{
    ...
    /// Наше такси
    /// </summary>
    public class CourierType_Car1 : ICourierType
    {
        /// <summary>
        /// Тип курьера
        /// </summary>
        public CourierVehicleType VechicleType => CourierVehicleType.Car1;
